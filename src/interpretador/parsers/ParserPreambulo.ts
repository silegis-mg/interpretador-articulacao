 ...
 */
import { Preambulo } from '../../dispositivos/agrupadores';
import Dispositivo from '../../dispositivos/Dispositivo';
import Contexto from './Contexto';
import ParserLinha from './ParserLinha';

export default class ParserPreambulo extends ParserLinha {
    constructor() {
        super(/^\s*PR[EÉ]-?[AÂ]MBULO\s*$/i);
    }

    onMatch(contexto: Contexto, m: RegExpExecArray): Dispositivo<any> | null {
        const item = new Preambulo('');
